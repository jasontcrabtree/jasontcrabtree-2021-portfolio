...
description: 'A case study about Service Design, Design Discovery and Facilitation in a large, traditional insurance company'
date: 2018-10-01
...
<CustomLazyImage
alt="Workshop in action photo, heavily blurred for privacy reasons. The group sitting around our table working with post-its on the wall."
src="./assets/images/repairer-allocation/workshop-hero-image.png"
/>
...
<CustomLazyImage
alt="The four key stakeholder groups of IAG Claims staff, Customers, Vehicle Repairers and IAG Vehicle Assessors"
src="/assets/images/repairer-allocation/01-stakeholder-map.png"
/>
...
<CustomLazyImage
alt="Our Customer Research sources relied on existing internal research, a survey completed by 350 customers, and interviews with internal Subject Matter Experts"
src=""
/>
