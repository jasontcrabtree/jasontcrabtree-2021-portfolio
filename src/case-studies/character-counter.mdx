---
title: 'Product Design: Building Character Counter, A Typography Tool'
description: 'Building character counting a web app to improve my design workflow and Vanilla JS in the process.'
date: 2019-02-26
image: 'https://res.cloudinary.com/jasontcrabtree/image/upload/v1573418454/Portfolio-Assets/CharCount-Cover-Image-4.png'
type: case-study
---

import GIFImage from '../components/contentComponents/GIFImage.js'
...
<GIFImage gifSrc="https://res.cloudinary.com/jasontcrabtree/image/upload/v1581088985/Portfolio-2020/hello-world-count.gif" gifAlt="GIF of CharacterCounter showing the 12 characters in the phrase Hello World"/>
...
<GIFImage gifSrc="https://res.cloudinary.com/jasontcrabtree/image/upload/v1581088985/Portfolio-2020/clicked-copy-animation.gif" gifAlt="GIF of the copy button in action, including the button label changing. Fancy."/>
